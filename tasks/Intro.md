...
**1.** Зарегистрируйтесь на сайте **[repl.it](https://repl.it/){:target="_blank" rel="noopener"}**;<br>
...
**8.** Скопированную ссылку (ваше решение ДЗ) нужно отправить на проверку. Для этого перейдите в личный кабинет на сайте **[https://netology.ru](https://netology.ru/){:target="_blank" rel="noopener"}**, в поле комментария к домашней работе вставьте скопированную ссылку и отправьте работу на проверку;
...
5. Загрузите ваше решение на сайт **[repl.it](https://repl.it/){:target="_blank" rel="noopener"}**, отправьте ссылку на него на проверку.
